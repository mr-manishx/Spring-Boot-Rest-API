...
//	}
	...
	public String toString() {
		return "CourseDetails [courseId=" + courseId + ", courseName=" + courseName + ", location=" + location
				+ ", courseCategory=" + courseCategory + ", facultyName=" + facultyName + ", fee=" + fee
				+ ", adminName=" + adminName + ", adminContact=" + adminContact + ", trainingMode=" + trainingMode
